...
The  AI esp32  rotary encoder  allows  me to  quickly add  a
(clickable) rotary encoder to  the keyboard. In addition, it
has acceleration detection which  can enhance scrolling over
large (rotary) ranges.
** Changes
:LOGBOOK:
