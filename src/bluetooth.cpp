...
// // stuff in here is related to various different keys such as ctrl, media
// keys
// // etc
...
//     HIDINPUT(1), 0x02,         //   INPUT (Data,Var,Abs,No
//     Wrap,Linear,Preferred
//                                //   State,No Null Position)
//     REPORT_COUNT(1), 0x01,     //   REPORT_COUNT (1) ; 1 byte (Reserved)
//     REPORT_SIZE(1), 0x08,      //   REPORT_SIZE (8)
//     HIDINPUT(1), 0x01,      //   INPUT (Const,Array,Abs,No
//     Wrap,Linear,Preferred
//                             //   State,No Null Position)
//     REPORT_COUNT(1), 0x05,  //   REPORT_COUNT (5) ; 5 bits (Num lock, Caps
//     lock,
...
//     HIDOUTPUT(1), 0x02,     //   OUTPUT (Data,Var,Abs,No
//     Wrap,Linear,Preferred
//                             //   State,No Null Position,Non-volatile)
//     REPORT_COUNT(1), 0x01,  //   REPORT_COUNT (1) ; 3 bits (Padding)
//     REPORT_SIZE(1), 0x03,   //   REPORT_SIZE (3)
//     HIDOUTPUT(1), 0x01,    //   OUTPUT (Const,Array,Abs,No
//     Wrap,Linear,Preferred
//                            //   State,No Null Position,Non-volatile)
...
//     USAGE(2), 0x23, 0x02,        //   Usage (WWW Home)            ; bit 7:
//     128 USAGE(2), 0x94, 0x01,        //   Usage (My Computer) ; bit 0: 1
