...
public:
  ...
  size_t led_pin = 25;
  size_t num_led = 1;
  std::vector<size_t> frame_buffer = std::vector<size_t>(num_led, 0);
  std::vector<size_t> draw_buffer = std::vector<size_t>(num_led, 0);
  ...
  size_t pin_sda = GPIO_NUM_4;
  size_t pin_scl = GPIO_NUM_15;
  size_t pin_reset = GPIO_NUM_16;
